...
#if 1
#define RECORD_IPL_ADDR 0xF900D000 //IPL
#define RECORD_BL_ADDR  0xF900C000 //BL
#define RECORD_ADDR     0xF9000000 //LINUX 0XA0
...
void recode_show(void)
{
    ...
    Chip_Inv_Cache_Range(RECORD_BL_ADDR, 0x400);
