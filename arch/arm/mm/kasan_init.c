				      ...
				      bool early)
{
	...
	do {
		/*
		 * Allocate and populate the shadow block of pud folded into
		 * into pmd if it doesn't already exist
		 */
		...
		/*
		 * We just immediately jump over the pud page directories since 
                 * we believe ARM32 will never gain four level page tables.
		 */
