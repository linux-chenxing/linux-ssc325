...
void ive_hal_set_coeff_matrix_transform(ive_hal_handle *handle, ive_ioc_coeff_matrix_transform *coeff)
{
    ...
    switch( coeff->chl_mode )
    {
        case IVE_IOC_MODE_MATRIX_TRANSFORM_C1:
            ...
            handle->reg_bank1.mask0 =  coeff->s16MatrixArray[0] & 0xFF;
            handle->reg_bank1.mask1 = (coeff->s16MatrixArray[0] & 0xFF00) >> 8;
        ...
        case IVE_IOC_MODE_MATRIX_TRANSFORM_C2:
            ...
            handle->reg_bank1.mask0 =  coeff->s16MatrixArray[0] & 0xFF;
            handle->reg_bank1.mask1 = (coeff->s16MatrixArray[0] & 0xFF00) >> 8;
            handle->reg_bank1.mask2 =  coeff->s16MatrixArray[1] & 0xFF;
            handle->reg_bank1.mask3 = (coeff->s16MatrixArray[1] & 0xFF00) >> 8;
            handle->reg_bank1.mask4 = 0;
            handle->reg_bank1.mask5 = 0;
            handle->reg_bank1.mask6 =  coeff->s16MatrixArray[2] & 0xFF;
            handle->reg_bank1.mask7 = (coeff->s16MatrixArray[2] & 0xFF00) >> 8;
            handle->reg_bank1.mask8 =  coeff->s16MatrixArray[3] & 0xFF;
            handle->reg_bank1.mask9 = (coeff->s16MatrixArray[3] & 0xFF00) >> 8;
            handle->reg_bank1.mask10 = 0;
            handle->reg_bank1.mask11 = 0;
            handle->reg_bank1.mask12 = 0;
            handle->reg_bank1.mask13 = 0;
        ...
        case IVE_IOC_MODE_MATRIX_TRANSFORM_C3:
            ...
            handle->reg_bank1.mask2 =   coeff->s16MatrixArray[1] & 0xFF;
            handle->reg_bank1.mask3 =  (coeff->s16MatrixArray[1] & 0xFF00) >> 8;
            handle->reg_bank1.mask4 =   coeff->s16MatrixArray[2] & 0xFF;
            handle->reg_bank1.mask5 =  (coeff->s16MatrixArray[2] & 0xFF00) >> 8;
            handle->reg_bank1.mask6 =   coeff->s16MatrixArray[3] & 0xFF;
            handle->reg_bank1.mask7 =  (coeff->s16MatrixArray[3] & 0xFF00) >> 8;
            handle->reg_bank1.mask8 =   coeff->s16MatrixArray[4] & 0xFF;
            handle->reg_bank1.mask9 =  (coeff->s16MatrixArray[4] & 0xFF00) >> 8;
            handle->reg_bank1.mask10 =  coeff->s16MatrixArray[5] & 0xFF;
            handle->reg_bank1.mask11 = (coeff->s16MatrixArray[5] & 0xFF00) >> 8;
            handle->reg_bank1.mask12 =  coeff->s16MatrixArray[6] & 0xFF;
            handle->reg_bank1.mask13 = (coeff->s16MatrixArray[6] & 0xFF00) >> 8;
            handle->reg_bank1.mask14 =  coeff->s16MatrixArray[7] & 0xFF;
            handle->reg_bank1.mask15 = (coeff->s16MatrixArray[7] & 0xFF00) >> 8;
            handle->reg_bank1.mask16 =  coeff->s16MatrixArray[8] & 0xFF;
            handle->reg_bank1.mask17 = (coeff->s16MatrixArray[8] & 0xFF00) >> 8;
            break;
