...
CAMCLK_RET_e HalCamClkGetDdrpllRate(void *pCfg)
{
    ...
    stRateCfg.u32Id = stParentCfg.u32ParentId;
    DrvCamClkImplGetRate(&stRateCfg);
    pDdrpllCfg->u32Rate = (u32)CamOsMathDivU64(((u64)stRateCfg.u32Freq * 4 * 4) << 19, (u64)((INREGMSK16(BASE_REG_ATOP_PA + REG_ID_19, 0x00FF) << 16) + INREGMSK16(BASE_REG_ATOP_PA + REG_ID_18, 0xFFFF)), NULL);
...
static void cpu_dvfs(u32 u32TargetLpf, u32 u32TargetPostDiv)
{
    ...
    while( !(INREG16(BASE_REG_RIU_PA + (0x1032BA << 1))&camclk_BIT0) );     //polling done
