...
int ms_uart_get_padmux(int tx_pad, u8 *padmux, u8 *pad_mode)
{
    ...
    switch(tx_pad)
    {
        ...
        case PAD_PM_GPIO0:
            ...
            TempU16 |= 0xF0; // reg_pm_pad_ext_mode #4~#7 =1
            ( *(volatile  unsigned short *)(0xFD000000 +(0x003F * 0x0200) +(0x55 << 2) ) ) = TempU16;

            TempU16 = ( *(volatile	unsigned short *)(0xFD000000 +(0x003F * 0x0200) +(0x00 << 2) ) );
            TempU16 &= 0xFFF0;//PAD_FUART_CTS
            ( *(volatile  unsigned short *)(0xFD000000 +(0x003F * 0x0200) +(0x00 << 2) ) ) = TempU16; 

            TempU16 = ( *(volatile	unsigned short *)(0xFD000000 +(0x003F * 0x0200) +(0x01 << 2) ) );
            TempU16 &= 0xFFF0; //PAD_FUART_RTS
            ( *(volatile  unsigned short *)(0xFD000000 +(0x003F * 0x0200) +(0x01 << 2) ) ) = TempU16;

            TempU16 = ( *(volatile  unsigned short *)(0xFD000000 +(0x003F * 0x0200) +(0x02 << 2) ) );
            TempU16 &= 0xFFF0;//PAD_FUART_CTS
            ( *(volatile  unsigned short *)(0xFD000000 +(0x003F * 0x0200) +(0x02 << 2) ) ) = TempU16; 

            TempU16 = ( *(volatile  unsigned short *)(0xFD000000 +(0x003F * 0x0200) +(0x03 << 2) ) );
            TempU16 &= 0xFFF0; //PAD_FUART_RTS
            ( *(volatile  unsigned short *)(0xFD000000 +(0x003F * 0x0200) +(0x03 << 2) ) ) = TempU16;
        ...
        case PAD_PM_GPIO2:
            ...
            //PADPMTOP setting
            TempU16 = ( *(volatile  unsigned short *)(0xFD000000 +(0x003F * 0x0200) +(0x55 << 2) ) );
            TempU16 |= 0xc0; // reg_pm_pad_ext_mode #6~#7 =1
            ( *(volatile  unsigned short *)(0xFD000000 +(0x003F * 0x0200) +(0x55 << 2) ) ) = TempU16;
