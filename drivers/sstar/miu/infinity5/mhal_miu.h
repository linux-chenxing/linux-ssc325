...
U8 HAL_MIU_Protect_Add_Ext_Feature(U8 u8ModeSel,U16 *pu8ProtectId,U8 u8Blockx,U8 bSetFlag,U8 bIdFlag,U8 bInvertFlag)__attribute__((weak));
U8 HAL_SetAccessFromVpaOnly(U8 u8Blockx,U32  u32BusStart,U32 u32BusEnd,U8 bSetFlag)__attribute__((weak));
