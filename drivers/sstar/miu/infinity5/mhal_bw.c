...
{
    OUTREG16((bank+REG_ID_2B), (id & 0x40) ? 0x01 : 0x00);
}
...
void halBWEffiMinPerConfig(int bank, int id)
{
    halBWResetFunc(bank);
    /*333*/
    halBWSetSumStep(bank, id, REQ_STATUS_PERIOD_16|BW_AVG_PERIOD_16|BW_STATUS_PERIOD_16);
...
{
   printk("I5 Not Support HW Occupancy\r\n");
}
