...
#define INT_PMSLEEP_IRQ_SAR             (PMSLEEP_IRQ_START +  0)
#define INT_PMSLEEP_IRQ_EMAC          (PMSLEEP_IRQ_START +  1)
#define INT_PMSLEEP_IRQ_RTC0           (PMSLEEP_IRQ_START +  2)
/* 0xE_01*/
#define INT_PMSLEEP_IR                        (PMSLEEP_IRQ_START +  3)

#define PMSLEEP_IRQ_END                 (PMSLEEP_IRQ_START +  4)
