...
#define    REG_CKG_LCD_BASE   (REG_SC_GP_CTRL_BASE+0x38*4)
#define    REG_CKG_LCD_OFFSET (0)
...
#define    REG_CKG_BDMA2_BASE   (REG_CKG_BASE+0x60*4)
#define    REG_CKG_BDMA2_OFFSET (8)

#define    REG_CKG_BDMA3_BASE   (REG_CKG_BASE+0x60*4)
#define    REG_CKG_BDMA3_OFFSET (12)

#define    REG_CKG_BIST_BASE   (REG_CKG_BASE+0x02*4)
#define    REG_CKG_BIST_OFFSET (0)

#define    REG_CKG_BIST_ISP_GP_BASE   (REG_CKG_BASE+0x03*4)
...
#define    REG_CKG_KEYPAD_BASE   (REG_CKG_BASE+0x38*4)
#define    REG_CKG_KEYPAD_OFFSET (0)
...
#define    REG_CKG_PSPI0_BASE   (REG_CKG_BASE+0x3A*4)
#define    REG_CKG_PSPI0_OFFSET (0)

#define    REG_CKG_PSPI1_BASE   (REG_CKG_BASE+0x3A*4)
#define    REG_CKG_PSPI1_OFFSET (8)
...
#define    REG_CKG_UPLL_SYNTH_BASE   (REG_CKG_BASE+0x39*4)
#define    REG_CKG_UPLL_SYNTH_OFFSET (0)
...
#define    REG_CLK_FCLK1_DFS_CFG_BASE   (REG_CKG_BASE+0x76*4)
#define    REG_CLK_FCLK1_DFS_CFG_OFFSET (1)

#define    REG_CLK_FCLK1_DFS_EN_BASE   (REG_CKG_BASE+0x76*4)
#define    REG_CLK_FCLK1_DFS_EN_OFFSET (0)
...
#define    REG_CLK_SC_PIXEL_DFS_CFG_BASE   (REG_CKG_BASE+0x77*4)
#define    REG_CLK_SC_PIXEL_DFS_CFG_OFFSET (1)

#define    REG_CLK_SC_PIXEL_DFS_EN_BASE   (REG_CKG_BASE+0x77*4)
#define    REG_CLK_SC_PIXEL_DFS_EN_OFFSET (0)
