...
#define MSB250X_HIGH_BANDWIDTH_EP(_dev, _ep)     _ep = ((_dev)->ep[7].ep.desc)? NULL : &((_dev)->ep[7].ep)
#define MSB250X_INTR_EP(_dev, _ep)     do { \
                                            int i; \
                                            for (i = 1; i < (MSB250X_MAX_ENDPOINTS - 1); i++) \
                                            { \
                                                if (NULL == (_dev)->ep[i].ep.desc) \
                                                { \
                                                    _ep = &(_dev)->ep[i].ep; \
                                                    break; \
                                                } \
