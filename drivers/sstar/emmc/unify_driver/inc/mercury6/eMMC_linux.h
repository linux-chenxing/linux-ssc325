...
#define reg_emmc_rstz_en                GET_REG_ADDR(PAD_CHIPTOP_BASE, 0x61) //[5:4]reg_emmc0_rst_mode [14:12]reg_emmc1_rst_mode
#ifdef CONFIG_MS_EMMC0
...
#ifdef CONFIG_MS_EMMC0
#define BIT_EMMC_MODE_1                 (BIT0|BIT_EMMC_RST) //[1:0]reg_emmc0_4b_mode   [5:4]reg_emmc0_rst_mode
#define BIT_EMMC_MODE_8X                (BIT2|BIT_EMMC_RST) //[3:2]reg_emmc0_8b_mode
#else
#define BIT_EMMC_MODE_1                 (BIT6|BIT_EMMC_RST) //[7:6]reg_emmc0_4b_mode   [14:12]reg_emmc1_rst_mode
#define BIT_EMMC_MODE_8X                (BIT8|BIT_EMMC_RST) //[9:8]reg_emmc0_8b_mode
#endif
