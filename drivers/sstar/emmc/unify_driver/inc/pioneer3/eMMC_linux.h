...
#ifndef __eMMC_PIONEER3_LINUX__
#define __eMMC_PIONEER3_LINUX__
...
#define BIT_CLKGEN_FCIE_MASK_VALUE          (BIT5|BIT4|BIT3|BIT2)
#define BIT_FCIE_CLK_SRC_SEL_VALUE          (BIT6) // 0: clk_xtal 12M, 1: clk_nfie_p1
#endif
...
#define PAD_PM_GPIO_BANK                GET_REG_ADDR(RIU_PM_BASE, 0x00780)//0Fh
...
// Not yet support
#else
#define BIT_SD_MODE_MASK_VALUE          (BIT8|BIT9|BIT12|BIT13)
...
#define BIT_EMMC1_MODE_MASK             (0) //[5:4]reg_emmc1_4b_mode [7:6]reg_emmc1_rst_mode
#define BIT_EMMC_MODE_MASK              (BIT_EMMC0_MODE_MASK|BIT_EMMC1_MODE_MASK)
#define BIT_EMMC_MODE_QFN68             (BIT9|BIT_EMMC_RST)
#define BIT_EMMC_MODE_QFN128            (BIT8|BIT_EMMC_RST)

#define BIT_EMMC_MODE_1                 gu32_emmc_pad_mux
#define BIT_EMMC_MODE_8X                gu32_emmc_pad_mux
...
#define eMMC_RST_L()                    {MDrv_GPIO_PadVal_Set(EMMC_RESET_PIN, PINMUX_FOR_GPIO_MODE);\
                                         MDrv_GPIO_Set_Low(EMMC_RESET_PIN);}

#define eMMC_RST_H()                    {MDrv_GPIO_PadVal_Set(EMMC_RESET_PIN, PINMUX_FOR_GPIO_MODE);\
                                         MDrv_GPIO_Set_High(EMMC_RESET_PIN);}
