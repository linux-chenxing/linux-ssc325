...
*
* Author: harry-cl.lin <harry-cl.lin@sigmastar.com.tw>
*
...
#if (SET_BY_DTS)
// IP_SD
#define REG_BANK_FCIE0_IP_0     0x20980U // Bank:0x1413
#define REG_BANK_FCIE1_IP_0     0x20A00U // Bank:0x1414
#define REG_BANK_FCIE2_IP_0     0x20A80U // Bank:0x1415
// IP_SDIO
#define REG_BANK_FCIE0_IP_1     0x20800U // Bank:0x1410
#define REG_BANK_FCIE1_IP_1     0x20880U // Bank:0x1411
#define REG_BANK_FCIE2_IP_1     0x20900U // Bank:0x1412
#else
#define REG_BANK_FCIE0          0x20980U // Bank:0x1413:0x20980U  Bank:0x1410:0x20800U
#define REG_BANK_FCIE1          0x20A00U // Bank:0x1414:0x20A00U  Bank:0x1411:0x20880U
#define REG_BANK_FCIE2          0x20A80U // Bank:0x1415:0x20A80U  Bank:0x1412:0x20900U
#endif
...
#if (SET_BY_DTS)
// IP_SD
#define reg_ckg_fcie_VALUE_IP_0             (0x43)
#define BIT_FCIE_CLK_GATING_VALUE_IP_0      (BIT0)
#define BIT_FCIE_CLK_INVERSE_VALUE_IP_0     (BIT1)
#define BIT_CLKGEN_FCIE_MASK_VALUE_IP_0     (BIT4|BIT3|BIT2)
#define BIT_FCIE_CLK_SRC_SEL_VALUE_IP_0     (BIT5) // 0: clk_xtal 12M, 1: clk_nfie_p1
// IP_SDIO
#define reg_ckg_fcie_VALUE_IP_1             (0x45)
#define BIT_FCIE_CLK_GATING_VALUE_IP_1      (BIT0)
#define BIT_FCIE_CLK_INVERSE_VALUE_IP_1     (BIT1)
#define BIT_CLKGEN_FCIE_MASK_VALUE_IP_1     (BIT4|BIT3|BIT2)
#define BIT_FCIE_CLK_SRC_SEL_VALUE_IP_1     (0) // 0: clk_xtal 12M, 1: clk_nfie_p1
#else
...
#if (SET_BY_DTS)
// IP_SD
#define BIT_SD_MODE_MASK_VALUE_IP_0         (BIT3|BIT2)
//
#define BIT_SD_MODE_SEL_VALUE_IP_0_PAD_0    (BIT2) // PAD_SD
#define BIT_SD_MODE_SEL_VALUE_IP_0_PAD_1    (0) // Not be defined
#define BIT_SD_MODE_SEL_VALUE_IP_0_PAD_2    (0) // Not be defined

// IP_SDIO
#define BIT_SD_MODE_MASK_VALUE_IP_1         (BIT8)
//
#define BIT_SD_MODE_SEL_VALUE_IP_1_PAD_0    (0) // Not be defined
#define BIT_SD_MODE_SEL_VALUE_IP_1_PAD_1    (BIT8) // PAD_SD1
#define BIT_SD_MODE_SEL_VALUE_IP_1_PAD_2    (0) // Not be defined
#else
#define BIT_SD_MODE_MASK_VALUE              (BIT3|BIT2)
#define BIT_SD_MODE_SEL_VALUE               (BIT2)
#endif
...
#if (SET_BY_DTS)
// PAD_SD
#define reg_driving_config_VALUE_PAD_0      (0x32)
#define BIT_DRIVING_CLK_VALUE_PAD_0         (BIT5)
#define BIT_DRIVING_CMD_VALUE_PAD_0         (BIT0)
#define BIT_DRIVING_DATA_VALUE_PAD_0        (BIT4|BIT3|BIT2|BIT1)
// PAD_SD1
#define reg_driving_config_VALUE_PAD_1      (0x30)
#define BIT_DRIVING_CLK_VALUE_PAD_1         (BIT5)
#define BIT_DRIVING_CMD_VALUE_PAD_1         (BIT4)
#define BIT_DRIVING_DATA_VALUE_PAD_1        (BIT3|BIT2|BIT1|BIT0)
// Not be defined
#define reg_driving_config_VALUE_PAD_2      (0xFFFF)
#define BIT_DRIVING_CLK_VALUE_PAD_2         (0xFFFF)
#define BIT_DRIVING_CMD_VALUE_PAD_2         (0xFFFF)
#define BIT_DRIVING_DATA_VALUE_PAD_2        (0xFFFF)
#else
#define reg_driving_config_VALUE            (0x32)
#define BIT_DRIVING_CLK_VALUE               (BIT5)
#define BIT_DRIVING_CMD_VALUE               (BIT0)
#define BIT_DRIVING_DATA_VALUE              (BIT4|BIT3|BIT2|BIT1)
#endif

#define reg_driving_config              GET_REG_ADDR(PAD_CHIPTOP_BASE, gRegDrivingCfg)
#define BIT_DRIVING_CLK                 (gBitDrivingClk)
#define BIT_DRIVING_CMD                 (gBitDrivingCmd)
#define BIT_DRIVING_DATA                (gBitDrivingData)
#endif

// PAD PE
#if (SET_BY_DTS)
// PAD_SD
#define SET_PE_ENABLE_PAD_0 (REG_FCIE_SETBIT(GET_REG_ADDR(PAD_CHIPTOP_BASE, 0x32), BIT12|BIT11|BIT10|BIT9|BIT8));
// PAD_SD1
#define SET_PE_ENABLE_PAD_1 (REG_FCIE_SETBIT(GET_REG_ADDR(PAD_CHIPTOP_BASE, 0x31), BIT4|BIT3|BIT2|BIT1|BIT0));
//
//#define SET_PE_ENABLE_PAD_2
#else
#define SET_PE_ENABLE   (REG_FCIE_SETBIT(GET_REG_ADDR(PAD_CHIPTOP_BASE, 0x32), BIT12|BIT11|BIT10|BIT9|BIT8));
#endif
