...
//  Macro and Define
//-------------------------------------------------------------------------------------------------
#define MHal_IIC_DELAY()      { CamOsUsDelay(1000); CamOsUsDelay(1000); CamOsUsDelay(1000); CamOsUsDelay(1000); CamOsUsDelay(1000); }//delay 5ms
...
#define CHIP_MIIC1_CLK_ADDR             (0x37*2+1)
    #define CHIP_MIIC1_CLK_OFF          (__BIT0)
    #define CHIP_MIIC1_CLK_ON_72M       (0)
    #define CHIP_MIIC1_CLK_ON_54M       (__BIT2)
    #define CHIP_MIIC1_CLK_ON_12M       (__BIT3)
    #define CHIP_MIIC1_CLK_ON_NCK       (__BIT2|__BIT3)
    #define CHIP_MIIC1_CLK_MSK          (__BIT0|__BIT1|__BIT2|__BIT3)
//for port 2
...
#define CHIP_MIIC2_CLK_ADDR             (0x37*2+1)
    #define CHIP_MIIC2_CLK_OFF           (__BIT4)
    #define CHIP_MIIC2_CLK_ON_72M       (0)
    #define CHIP_MIIC2_CLK_ON_54M       (__BIT6)
    #define CHIP_MIIC2_CLK_ON_12M       (__BIT7)
    #define CHIP_MIIC2_CLK_ON_NCK       (__BIT6|__BIT7)
    #define CHIP_MIIC2_CLK_MSK          (__BIT4|__BIT5|__BIT6|__BIT7)
...
#define CHIP_MIIC3_CLK_ADDR             (0x39*2+1)
    #define CHIP_MIIC3_CLK_OFF          (__BIT0)
    #define CHIP_MIIC3_CLK_ON_72M       (0)
    #define CHIP_MIIC3_CLK_ON_54M       (__BIT2)
    #define CHIP_MIIC3_CLK_ON_12M       (__BIT3)
    #define CHIP_MIIC3_CLK_ON_NCK       (__BIT2|__BIT3)
    #define CHIP_MIIC3_CLK_MSK          (__BIT0|__BIT1|__BIT2|__BIT3)
