...
int mmc_set_signal_voltage(struct mmc_host *host, int signal_voltage, u32 ocr)
{
	...
	mmc_delay(8);//reduce from 10 ms to 8 ms for busy waiting, thus saves scheduled time
...
void mmc_power_up(struct mmc_host *host, u32 ocr)
{
	 ...
	 */
	mmc_delay(2);//reduced from 10 to 2 for faster booting. 2 times of T-power_up
