...
/* 00h ~ 0Fh */
#define MSB250X_OTG0_FADDR_REG			            GET_BASE_ADDR_BY_BANK(OTG0_BASE_ADDR, 0x00)
#define MSB250X_OTG0_PWR_REG				        (MSB250X_OTG0_FADDR_REG + 1)
#define MSB250X_OTG0_INTRTX_REG    		            GET_BASE_ADDR_BY_BANK(OTG0_BASE_ADDR, 0x02)
/* 03h reserved */
#define MSB250X_OTG0_INTRRX_REG    		            GET_BASE_ADDR_BY_BANK(OTG0_BASE_ADDR, 0x04)
/* 05h reserved */
#define MSB250X_OTG0_INTRTXE_REG  		            GET_BASE_ADDR_BY_BANK(OTG0_BASE_ADDR, 0x06)
#define MSB250X_OTG0_INTRTX1E_REG                   GET_BASE_ADDR_BY_BANK(OTG0_BASE_ADDR, 0x06)
#define MSB250X_OTG0_INTRTX2E_REG                   (MSB250X_OTG0_INTRTX1E_REG + 1)
/* 07h reserved */
#define MSB250X_OTG0_INTRRXE_REG  		            GET_BASE_ADDR_BY_BANK(OTG0_BASE_ADDR, 0x08)
#define MSB250X_OTG0_INTRRX1E_REG  		            GET_BASE_ADDR_BY_BANK(OTG0_BASE_ADDR, 0x08)
#define MSB250X_OTG0_INTRRX2E_REG  		            (MSB250X_OTG0_INTRRX1E_REG + 1)
/* 09h reserved */
#define MSB250X_OTG0_INTRUSB_REG  		            GET_BASE_ADDR_BY_BANK(OTG0_BASE_ADDR, 0x0A)
#define MSB250X_OTG0_INTRUSBE_REG 		            (MSB250X_OTG0_INTRUSB_REG + 1)
#define MSB250X_OTG0_FRAME_L_REG   		            GET_BASE_ADDR_BY_BANK(OTG0_BASE_ADDR, 0x0C)
#define MSB250X_OTG0_FRAME_H_REG  		            (MSB250X_OTG0_FRAME_L_REG + 1)
#define MSB250X_OTG0_INDEX_REG       		        GET_BASE_ADDR_BY_BANK(OTG0_BASE_ADDR, 0x0E)
#define MSB250X_OTG0_TESTMODE_REG  		            (MSB250X_OTG0_INDEX_REG + 1)
...
#define MSB250X_OTG0_EP0_CSR0_REG        		    GET_BASE_ADDR_BY_BANK(OTG0_BASE_ADDR, 0x102)
#define MSB250X_OTG0_EP0_CSR0_FLSH_REG  		    (MSB250X_OTG0_EP0_CSR0_REG + 1)
/* 14h ~ 17h reserved */
#define MSB250X_OTG0_EP0_COUNT0_REG 			    GET_BASE_ADDR_BY_BANK(OTG0_BASE_ADDR, 0x108)
/* 19h ~ 1Eh reserved */
#define MSB250X_OTG0_EP0_CONFDATA_REG 		        GET_BASE_ADDR_BY_BANK(OTG0_BASE_ADDR, 0x10F)

/* 10h ~ 1Fh */
#define MSB250X_OTG0_EP_TXMAP_L_REG(x)  		    GET_BASE_ADDR_BY_BANK(OTG0_BASE_ADDR, (0x100 + (0x10 * x)))
#define MSB250X_OTG0_EP_TXMAP_H_REG(x)  		    (MSB250X_OTG0_EP_TXMAP_L_REG(x) + 1)

/* for EP_SEL != 0, 12h ~ 1Fh (EP1 ~ EPx) */
#define MSB250X_OTG0_EP_TXCSR1_REG(x) 			    GET_BASE_ADDR_BY_BANK(OTG0_BASE_ADDR, (0x102 + (0x10 * x)))
#define MSB250X_OTG0_EP_TXCSR2_REG(x) 			    (MSB250X_OTG0_EP_TXCSR1_REG(x) + 1)
#define MSB250X_OTG0_EP_RXMAP_L_REG(x) 		        GET_BASE_ADDR_BY_BANK(OTG0_BASE_ADDR, (0x104 + (0x10 * x)))
#define MSB250X_OTG0_EP_RXMAP_H_REG(x) 		        (MSB250X_OTG0_EP_RXMAP_L_REG(x) + 1)
#define MSB250X_OTG0_EP_RXCSR1_REG(x) 			    GET_BASE_ADDR_BY_BANK(OTG0_BASE_ADDR, (0x106 + (0x10 * x)))
#define MSB250X_OTG0_EP_RXCSR2_REG(x) 			    (MSB250X_OTG0_EP_RXCSR1_REG(x) + 1)
#define MSB250X_OTG0_EP_RXCOUNT_L_REG(x) 		    GET_BASE_ADDR_BY_BANK(OTG0_BASE_ADDR, (0x108 + (0x10 * x)))
#define MSB250X_OTG0_EP_RXCOUNT_H_REG(x) 		    (MSB250X_OTG0_EP_RXCOUNT_L_REG(x) + 1)
#define MSB250X_OTG0_EP_FIFO_COUNT(x)               GET_BASE_ADDR_BY_BANK(OTG0_BASE_ADDR, (0x108 + (0x10 * (x))))

/* for EP_SEL = 0, 12h ~ 1Fh */
#define MSB250X_OTG0_CSR0_REG         		        GET_BASE_ADDR_BY_BANK(OTG0_BASE_ADDR, 0x12)
#define MSB250X_OTG0_CSR0_FLSH_REG  		        (MSB250X_OTG0_CSR0_REG + 1)
/* 14h ~ 17h reserved */
#define MSB250X_OTG0_COUNT0_REG 			        GET_BASE_ADDR_BY_BANK(OTG0_BASE_ADDR, 0x18)
/* 19h ~ 1Eh reserved */
#define MSB250X_OTG0_CONFDATA_REG 		            GET_BASE_ADDR_BY_BANK(OTG0_BASE_ADDR, 0x1F)

/* for EP_SEL != 0, 12h ~ 1Fh (EP1 ~ EP3) */
#define MSB250X_OTG0_TXCSR1_REG 			        GET_BASE_ADDR_BY_BANK(OTG0_BASE_ADDR, 0x12)
#define MSB250X_OTG0_TXCSR2_REG 			        (MSB250X_OTG0_TXCSR1_REG + 1)
#define MSB250X_OTG0_RXMAP_L_REG 		            GET_BASE_ADDR_BY_BANK(OTG0_BASE_ADDR, 0x14)
#define MSB250X_OTG0_RXMAP_H_REG 		            (MSB250X_OTG0_RXMAP_L_REG + 1)
#define MSB250X_OTG0_RXCSR1_REG 			        GET_BASE_ADDR_BY_BANK(OTG0_BASE_ADDR, 0x16)
#define MSB250X_OTG0_RXCSR2_REG 			        (MSB250X_OTG0_RXCSR1_REG + 1)
#define MSB250X_OTG0_RXCOUNT_L_REG 		            GET_BASE_ADDR_BY_BANK(OTG0_BASE_ADDR, 0x18)
#define MSB250X_OTG0_RXCOUNT_H_REG 		            (MSB250X_OTG0_RXCOUNT_L_REG + 1)

#define MSB250X_OTG0_TXTYPE                         GET_BASE_ADDR_BY_BANK(OTG0_BASE_ADDR, 0x1A)
#define MSB250X_OTG0_TXINTERVAL                     GET_BASE_ADDR_BY_BANK(OTG0_BASE_ADDR, 0x1B)
#define MSB250X_OTG0_RXTYPE                         GET_BASE_ADDR_BY_BANK(OTG0_BASE_ADDR, 0x1C)
#define MSB250X_OTG0_RXINTERVAL                     GET_BASE_ADDR_BY_BANK(OTG0_BASE_ADDR, 0x1D)

#define MSB250X_OTG0_FIFOSIZE_REG 		            GET_BASE_ADDR_BY_BANK(OTG0_BASE_ADDR, 0x1E)

#define OTG0_EP_FIFO_ACCESS_L(x)                    GET_BASE_ADDR_BY_BANK(OTG0_BASE_ADDR, (0x20 + (0x4 * (x))))

/* 30h ~ 5Fh reserved */

/* 60h */
#define MSB250X_OTG0_DEVCTL_REG 			        GET_BASE_ADDR_BY_BANK(OTG0_BASE_ADDR, 0x60)

/* 80h ~ 8Fh */
#define MSB250X_OTG0_USB_CFG0_L 			        GET_BASE_ADDR_BY_BANK(OTG0_BASE_ADDR, 0x80)
#define MSB250X_OTG0_USB_CFG0_H 			        (MSB250X_OTG0_USB_CFG0_L + 1)
#define MSB250X_OTG0_USB_CFG1_L  			        GET_BASE_ADDR_BY_BANK(OTG0_BASE_ADDR, 0x82)
#define MSB250X_OTG0_USB_CFG1_H  			        (MSB250X_OTG0_USB_CFG1_L + 1)
#define MSB250X_OTG0_USB_CFG2_L  			        GET_BASE_ADDR_BY_BANK(OTG0_BASE_ADDR, 0x84)
#define MSB250X_OTG0_USB_CFG2_H  			        (MSB250X_OTG0_USB_CFG2_L + 1)
#define MSB250X_OTG0_USB_CFG3_L  			        GET_BASE_ADDR_BY_BANK(OTG0_BASE_ADDR, 0x86)
#define MSB250X_OTG0_USB_CFG3_H  			        (MSB250X_OTG0_USB_CFG3_L + 1)
#define MSB250X_OTG0_USB_CFG4_L  			        GET_BASE_ADDR_BY_BANK(OTG0_BASE_ADDR, 0x88)
#define MSB250X_OTG0_USB_CFG4_H  			        (MSB250X_OTG0_USB_CFG4_L + 1)
#define MSB250X_OTG0_USB_CFG5_L  			        GET_BASE_ADDR_BY_BANK(OTG0_BASE_ADDR, 0x8A)
#define MSB250X_OTG0_USB_CFG5_H  			        (MSB250X_OTG0_USB_CFG5_L + 1)
#define MSB250X_OTG0_USB_CFG6_L   			        GET_BASE_ADDR_BY_BANK(OTG0_BASE_ADDR, 0x8C)
#define MSB250X_OTG0_USB_CFG6_H  			        (MSB250X_OTG0_USB_CFG6_L + 1)
#define MSB250X_OTG0_USB_CFG7_L   	                GET_BASE_ADDR_BY_BANK(OTG0_BASE_ADDR, 0x8E)
#define MSB250X_OTG0_USB_CFG7_H  	                (MSB250X_OTG0_USB_CFG7_L + 1)
#define MSB250X_OTG0_USB_CFG8_L   	                GET_BASE_ADDR_BY_BANK(OTG0_BASE_ADDR, 0x90)
#define MSB250X_OTG0_USB_CFG8_H  	                (MSB250X_OTG0_USB_CFG8_L + 1)
#define MSB250X_OTG0_USB_CFG9_L   	                GET_BASE_ADDR_BY_BANK(OTG0_BASE_ADDR, 0x92)
#define MSB250X_OTG0_USB_CFG9_H  	                (MSB250X_OTG0_USB_CFG8_L + 1)
...
#define MSB250X_OTG0_AUTONAK0_EN                    0x20
...
#define MSB250X_OTG0_AUTONAK0_AllowAck              0x40
...
/* 200h */
#define MSB250X_OTG0_DMA_INTR                       GET_BASE_ADDR_BY_BANK(OTG0_BASE_ADDR, 0x200)
#define MSB250X_OTG0_DMA_CNTL(x)                    GET_BASE_ADDR_BY_BANK(OTG0_BASE_ADDR, (0x204 + (0x10 * (x - 1))))
#define MSB250X_OTG0_DMA_ADDR(x)                    GET_BASE_ADDR_BY_BANK(OTG0_BASE_ADDR, (0x208 + (0x10 * (x - 1))))
#define MSB250X_OTG0_DMA_ADDR_LW(x)                 GET_BASE_ADDR_BY_BANK(OTG0_BASE_ADDR, (0x208 + (0x10 * (x - 1))))
#define MSB250X_OTG0_DMA_ADDR_HW(x)                 GET_BASE_ADDR_BY_BANK(OTG0_BASE_ADDR, (0x20A + (0x10 * (x - 1))))
#define MSB250X_OTG0_DMA_COUNT(x)                   GET_BASE_ADDR_BY_BANK(OTG0_BASE_ADDR, (0x20C + (0x10 * (x - 1))))
#define MSB250X_OTG0_DMA_COUNT_LW(x)                GET_BASE_ADDR_BY_BANK(OTG0_BASE_ADDR, (0x20C + (0x10 * (x - 1))))
#define MSB250X_OTG0_DMA_COUNT_HW(x)                GET_BASE_ADDR_BY_BANK(OTG0_BASE_ADDR, (0x20E + (0x10 * (x - 1))))
