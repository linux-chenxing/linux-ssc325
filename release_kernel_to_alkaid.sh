...
then
    ...
    # cardv DEMO SPI_NOR
    echo make infinity6e_ssc013a_s01a_miniGUI_defconfig [${GCC_VERSION}]
    make infinity6e_ssc013a_s01a_miniGUI_defconfig; make clean; make -j ${jobs}
    cd ${RELEASE_PATH}
    ./release.sh -k ${kernel_dir} -b DEMO -p cardv -f nor -c ${chip} -l glibc -v ${GCC_VERSION} -i ${API_VERSION}
    cd ${kernel_dir}

    echo make infinity6e_ssc013a_s01a_miniGUI_fastboot_defconfig [${GCC_VERSION}]
    make infinity6e_ssc013a_s01a_miniGUI_fastboot_defconfig; make clean; make -j ${jobs}
    cd ${RELEASE_PATH}
    ./release.sh -k ${kernel_dir} -b DEMO-fastboot -p cardv -f nor -c ${chip} -l glibc -v ${GCC_VERSION} -i ${API_VERSION}
    cd ${kernel_dir}
    ...
    cd ${RELEASE_PATH}
    ./release.sh -k ${kernel_dir} -b 012B-fastboot -p ipc -f nor -c ${chip} -l glibc -v ${GCC_VERSION} -i ${API_VERSION}
    cd ${kernel_dir}
    ...
    replace_dtb_to_kernel ${CROSS_COMPILE} infinity6e-ssc013a-s01a
    cd ${RELEASE_PATH}
    ./release.sh -k ${kernel_dir} -b 013A-fastboot -p ipc -f nor -c ${chip} -l glibc -v ${GCC_VERSION} -i ${API_VERSION}
    cd ${kernel_dir}
    ...
    cd ${RELEASE_PATH}
    ./release.sh -k ${kernel_dir} -b 012B-fastboot -p ipc -f spinand -c ${chip} -l glibc -v ${GCC_VERSION} -i ${API_VERSION}
    cd ${kernel_dir}
    ...
    replace_dtb_to_kernel ${CROSS_COMPILE} infinity6e-ssc013a-s01a
    cd ${RELEASE_PATH}
    ./release.sh -k ${kernel_dir} -b 013A-fastboot -p ipc -f spinand -c ${chip} -l glibc -v ${GCC_VERSION} -i ${API_VERSION}
    cd ${kernel_dir}
    ...
    cd ${RELEASE_PATH}
    ./release.sh -k ${kernel_dir} -b 012B-fastboot -p usbcam -f nor -c ${chip} -l glibc -v ${GCC_VERSION} -i ${API_VERSION}
    cd ${kernel_dir}
    ...
    replace_dtb_to_kernel ${CROSS_COMPILE} infinity6e-ssc013a-s01a
    cd ${RELEASE_PATH}
    ./release.sh -k ${kernel_dir} -b 013A-fastboot -p usbcam -f nor -c ${chip} -l glibc -v ${GCC_VERSION} -i ${API_VERSION}
    cd ${kernel_dir}
    ...
    cd ${RELEASE_PATH}
    ./release.sh -k ${kernel_dir} -b 012B-fastboot -p usbcam -f spinand -c ${chip} -l glibc -v ${GCC_VERSION} -i ${API_VERSION}
    cd ${kernel_dir}
    ...
    replace_dtb_to_kernel ${CROSS_COMPILE} infinity6e-ssc013a-s01a
    cd ${RELEASE_PATH}
    ./release.sh -k ${kernel_dir} -b 013A-fastboot -p usbcam -f spinand -c ${chip} -l glibc -v ${GCC_VERSION} -i ${API_VERSION}
    cd ${kernel_dir}
    ########################## uclibc ###############################
    TOOLCHAIN_PATH="/tools/toolchain/arm-buildroot-linux-uclibcgnueabihf-4.9.4/bin"
    declare -x PATH=${TOOLCHAIN_PATH}:$PATH
    ...
    make infinity6e_ssc012b_s01a_fastboot_defconfig; make clean; make -j ${jobs}
    cd ${RELEASE_PATH}
    ./release.sh -k ${kernel_dir} -b 012B-fastboot -p ipc -f nor -c ${chip} -l uclibc -v ${GCC_VERSION} -i ${API_VERSION}
    cd ${kernel_dir}
    ...
    replace_dtb_to_kernel ${CROSS_COMPILE} infinity6e-ssc013a-s01a
    cd ${RELEASE_PATH}
    ./release.sh -k ${kernel_dir} -b 013A-fastboot -p ipc -f nor -c ${chip} -l uclibc -v ${GCC_VERSION} -i ${API_VERSION}
    cd ${kernel_dir}
    ...
    replace_dtb_to_kernel ${CROSS_COMPILE} infinity6e-ssc013a-s01a
    cd ${RELEASE_PATH}
    ./release.sh -k ${kernel_dir} -b 013A-fastboot -p ipc -f spinand -c ${chip} -l uclibc -v ${GCC_VERSION} -i ${API_VERSION}
    cd ${kernel_dir}
    ...
    make infinity6e_ssc012b_s01a_usbcam_fastboot_defconfig; make clean; make -j ${jobs}
    cd ${RELEASE_PATH}
    ./release.sh -k ${kernel_dir} -b 012B-fastboot -p usbcam -f nor -c ${chip} -l uclibc -v ${GCC_VERSION} -i ${API_VERSION}
    cd ${kernel_dir}
    ...
    replace_dtb_to_kernel ${CROSS_COMPILE} infinity6e-ssc013a-s01a
    cd ${RELEASE_PATH}
    ./release.sh -k ${kernel_dir} -b 013A-fastboot -p usbcam -f nor -c ${chip} -l uclibc -v ${GCC_VERSION} -i ${API_VERSION}
    cd ${kernel_dir}
    ...
    make infinity6e_ssc012b_s01a_spinand_usbcam_fastboot_defconfig; make clean; make -j ${jobs}
    cd ${RELEASE_PATH}
    ./release.sh -k ${kernel_dir} -b 012B-fastboot -p usbcam -f spinand -c ${chip} -l uclibc -v ${GCC_VERSION} -i ${API_VERSION}
    cd ${kernel_dir}
    ...
    replace_dtb_to_kernel ${CROSS_COMPILE} infinity6e-ssc013a-s01a
    cd ${RELEASE_PATH}
    ./release.sh -k ${kernel_dir} -b 013A-fastboot -p usbcam -f spinand -c ${chip} -l uclibc -v ${GCC_VERSION} -i ${API_VERSION}
    cd ${kernel_dir}
fi
...
then
    ...
    make clean;make -j ${jobs}
    cd ${alkaid_dir}/project/kbuild/4.9.84/
    ./release.sh -k ${kernel_dir} -b 009A-fastboot -p ipc -f nor -c ${chip} -l glibc -v ${GCC_VERSION}
    cd ${kernel_dir}
    ...
    make clean;make -j ${jobs}
    cd ${alkaid_dir}/project/kbuild/4.9.84/
    ./release.sh -k ${kernel_dir} -b 009A-fastboot -p ipc -f spinand -c ${chip} -l glibc -v ${GCC_VERSION}
    cd ${kernel_dir}
    ...
    make clean;make -j ${jobs}
    cd ${alkaid_dir}/project/kbuild/4.9.84/
    ./release.sh -k ${kernel_dir} -b 009B-fastboot -p ipc -f nor -c ${chip} -l glibc -v ${GCC_VERSION}
    cd ${kernel_dir}
    ...
    make clean;make -j ${jobs}
    cd ${alkaid_dir}/project/kbuild/4.9.84/
    ./release.sh -k ${kernel_dir} -b 009B-fastboot -p ipc -f spinand -c ${chip} -l glibc -v ${GCC_VERSION}
    cd ${kernel_dir}
    ...
    make clean;make -j ${jobs}
    cd ${alkaid_dir}/project/kbuild/4.9.84/
    ./release.sh -k ${kernel_dir} -b 009A-fastboot -p ipc -f nor -c ${chip} -l uclibc -v 4.9.4
    cd ${kernel_dir}
    ...
    make clean;make -j ${jobs}
    cd ${alkaid_dir}/project/kbuild/4.9.84/
    ./release.sh -k ${kernel_dir} -b 009A-fastboot -p ipc -f spinand -c ${chip} -l uclibc -v 4.9.4
    cd ${kernel_dir}
    ...
    make clean;make -j ${jobs}
    cd ${alkaid_dir}/project/kbuild/4.9.84/
    ./release.sh -k ${kernel_dir} -b 009B-fastboot -p ipc -f nor -c ${chip} -l uclibc -v 4.9.4
    cd ${kernel_dir}
    ...
    make clean;make -j ${jobs}
    cd ${alkaid_dir}/project/kbuild/4.9.84/
    ./release.sh -k ${kernel_dir} -b 009B-fastboot -p ipc -f spinand -c ${chip} -l uclibc -v 4.9.4
    cd ${kernel_dir}
