...
then
    ...
    echo make infinity6e_ssc013a_s01a_miniGUI_fastboot_defconfig [gclibc 8.2.0]
    make infinity6e_ssc013a_s01a_miniGUI_fastboot_defconfig
    make clean;make -j ${jobs}
    cd ${alkaid_dir}/project/kbuild/4.9.84/
    ./release.sh -k ${kernel_dir} -b DEMO-fastboot -p cardv -f nor -c ${chip} -l glibc -v ${GCC_VERSION} -i 4.9.84
    cd ${kernel_dir}
    ...
    make infinity6e_ssc012b_s01a_fastboot_defconfig
    make clean;make -j ${jobs}
    cd ${alkaid_dir}/project/kbuild/4.9.84/
    ./release.sh -k ${kernel_dir} -b 012B-fastboot -p ipc -f nor -c ${chip} -l glibc -v ${GCC_VERSION} -i 4.9.84
    cd ${kernel_dir}
    ...
    replace_dtb_to_kernel ${CROSS_COMPILE} infinity6e-ssc013a-s01a
    cd ${alkaid_dir}/project/kbuild/4.9.84/
    ./release.sh -k ${kernel_dir} -b 013A-fastboot -p ipc -f nor -c ${chip} -l glibc -v ${GCC_VERSION} -i 4.9.84
    cd ${kernel_dir}

    # 012B SPI_NAND
    echo make infinity6e_ssc012b_s01a_spinand_fastboot_defconfig
    make infinity6e_ssc012b_s01a_spinand_fastboot_defconfig
    make clean;make -j ${jobs}
    cd ${alkaid_dir}/project/kbuild/4.9.84/
    ./release.sh -k ${kernel_dir} -b 012B-fastboot -p ipc -f spinand -c ${chip} -l glibc -v ${GCC_VERSION} -i 4.9.84
    cd ${kernel_dir}
    ...
    replace_dtb_to_kernel ${CROSS_COMPILE} infinity6e-ssc013a-s01a
    cd ${alkaid_dir}/project/kbuild/4.9.84/
    ./release.sh -k ${kernel_dir} -b 013A-fastboot -p ipc -f spinand -c ${chip} -l glibc -v ${GCC_VERSION} -i 4.9.84
    cd ${kernel_dir}
    ...
    make clean;make -j ${jobs}
    cd ${alkaid_dir}/project/kbuild/4.9.84/
    ./release.sh -k ${kernel_dir} -b 012B-fastboot -p ipc -f nor -c ${chip} -l uclibc -v ${GCC_VERSION} -i 4.9.84
    cd ${kernel_dir}
    ...
    replace_dtb_to_kernel ${CROSS_COMPILE} infinity6e-ssc013a-s01a
    cd ${alkaid_dir}/project/kbuild/4.9.84/
    ./release.sh -k ${kernel_dir} -b 013A-fastboot -p ipc -f nor -c ${chip} -l uclibc -v ${GCC_VERSION} -i 4.9.84
    cd ${kernel_dir}
    ...
    make clean;make -j ${jobs}
    cd ${alkaid_dir}/project/kbuild/4.9.84/
    ./release.sh -k ${kernel_dir} -b 012B-fastboot -p ipc -f spinand -c ${chip} -l uclibc -v ${GCC_VERSION} -i 4.9.84
    cd ${kernel_dir}
    ...
    replace_dtb_to_kernel ${CROSS_COMPILE} infinity6e-ssc013a-s01a
    cd ${alkaid_dir}/project/kbuild/4.9.84/
    ./release.sh -k ${kernel_dir} -b 013A-fastboot -p ipc -f spinand -c ${chip} -l uclibc -v ${GCC_VERSION} -i 4.9.84
    cd ${kernel_dir}
    ...
    make clean;make -j ${jobs}
    cd ${alkaid_dir}/project/kbuild/4.9.84/
    ./release.sh -k ${kernel_dir} -b 012B -p usbcam -f nor -c ${chip} -l uclibc -v ${GCC_VERSION} -i 4.9.84
    cd ${kernel_dir}
    ...
    replace_dtb_to_kernel ${CROSS_COMPILE} infinity6e-ssc013a-s01a
    cd ${alkaid_dir}/project/kbuild/4.9.84/
    ./release.sh -k ${kernel_dir} -b 013A -p usbcam -f nor -c ${chip} -l uclibc -v ${GCC_VERSION} -i 4.9.84
    cd ${kernel_dir}
    ...
    make clean;make -j ${jobs}
    cd ${alkaid_dir}/project/kbuild/4.9.84/
    ./release.sh -k ${kernel_dir} -b 012B -p usbcam -f spinand -c ${chip} -l uclibc -v ${GCC_VERSION} -i 4.9.84
    cd ${kernel_dir}
    ...
    replace_dtb_to_kernel ${CROSS_COMPILE} infinity6e-ssc013a-s01a
    cd ${alkaid_dir}/project/kbuild/4.9.84/
    ./release.sh -k ${kernel_dir} -b 013A -p usbcam -f spinand -c ${chip} -l uclibc -v ${GCC_VERSION} -i 4.9.84
    cd ${kernel_dir}
fi
